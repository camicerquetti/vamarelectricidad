...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Guardar nombre cliente si lo envían
    ...
    if (isset($_POST['codigo']) && isset($_POST['cantidad'])) {
        ...
        if ($res->num_rows > 0) {
            ...
            if (isset($_SESSION['presupuesto'][$codigo])) {
                $_SESSION['presupuesto'][$codigo]['cantidad'] += $cantidad;
            } else {
                $producto['cantidad'] = $cantidad;
                $_SESSION['presupuesto'][$codigo] = $producto;
            }
        } else {
    ...
    if (isset($_POST['confirmar']) && isset($_POST['metodo_pago'])) {
        ...
        // Insertar presupuesto con cliente
        ...
        // Insertar productos en detalles
...
<div style="text-align:center; margin-top:20px;">
    <form action="lista_presupuestosempleado.php" method="GET" style="display:inline;">
...
<!-- Form para agregar producto y cliente -->
        ...
        <table>
            ...
            <?php foreach($_SESSION['presupuesto'] as $codigo => $item): 
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="cantidades[<?= $codigo ?>]" value="<?= $item['cantidad'] ?>" min="1">
                    </td>
                    <td><?= number_format($item['precio'],2) ?></td>
                    <td><?= number_format($total_item,2) ?></td>
                    <td>
                        <a href="presupuesto.php?eliminar=<?= $codigo ?>" style="color:red;">Eliminar</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            <tr>
            ...
            <tr>
                <th colspan="4" style="text-align:right;">IVA (21%):</th>
